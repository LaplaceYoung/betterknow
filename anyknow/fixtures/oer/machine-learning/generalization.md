...
Source: https://d2l.ai/chapter_linear-regression/generalization.html
...
Formally the training error is expressed as a *sum* (with the same notation as the figure):
...
*Figure omitted.* Influence of model complexity on underfitting and overfitting.
