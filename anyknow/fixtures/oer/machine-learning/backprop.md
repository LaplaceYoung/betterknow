...
Title: Forward Propagation, Backward Propagation, and Computational Graphs
...
Source: https://d2l.ai/chapter_multilayer-perceptrons/backprop.html
...
The figure contains the graph associated
...
*Figure omitted.* Computational graph of forward propagation.
...
whose computational graph is in the figure,
...
On the one hand,
computing the regularization term the equation
...
the equation during backpropagation
