...
Source: https://www.py4e.com/html3/05-iterations
...
**Exercise 1:** Write a program which repeatedly reads integers until the
user enters "done". Once "done" is entered, print out the total, count,
and average of the integers. If the user enters anything other than an
integer, detect their mistake using `try` and
